...
def checkforbubbles():
    bubbles = False
    bubblecolour = (68, 252, 234)  # Double-check this value
    s = ag.screenshot()

    # Convert screenshot to a numpy array for more efficient color checking
    img = np.array(s)
    area = img[150:750, 300:1620]  # This assumes the y-coordinate first, then x-coordinate
